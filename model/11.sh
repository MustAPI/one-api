...
function close_content_filter() {
  ...
  local dynamicThrottlingEnabled=false
  if [ "$skuName" == "Standard" ]; then
...
function az_export_accounts() {
  ...
  accLen=$(echo "$accounts" | jq '. | length')
  echo "Accounts len: ${accLen}"
  if [ "$accLen" -eq 0 ]; then
    ding "No accounts to export in subscription ${sub}-${subnum}"
    return 1
  fi
...
default_config_json=$(cat <<EOF
{
  "AustraliaEast": [
    ...
    {"deployName": "gpt-4o", "modelName": "gpt-4o", "version": "2024-05-13", "capacity": 30, "skuName":"GlobalStandard"},
    {"deployName": "gpt-4-turbo-2024-04-09", "modelName": "gpt-4", "version": "turbo-2024-04-09", "capacity": 100, "skuName":"ProvisionedManaged"},
    {"deployName": "gpt-4-turbo", "modelName": "gpt-4", "version": "turbo-2024-04-09", "capacity": 8, "skuName":"GlobalStandard"},
    {"deployName": "gpt-4-vision-preview", "modelName": "gpt-4", "version": "vision-preview", "capacity": 3}
  ],
  "CanadaEast": [
    {"deployName": "gpt-35-turbo", "modelName": "gpt-35-turbo", "version": "0613", "capacity": 30},
    {"deployName": "gpt-4-1106-preview", "modelName": "gpt-4", "version": "1106-Preview", "capacity": 8},
    {"deployName": "gpt-4o", "modelName": "gpt-4o", "version": "2024-05-13", "capacity": 30, "skuName":"GlobalStandard"},
    {"deployName": "gpt-4o-2024-05-13", "modelName": "gpt-4o", "version": "2024-05-13", "capacity": 100, "skuName":"ProvisionedManaged"},
    {"deployName": "gpt-4-turbo", "modelName": "gpt-4", "version": "turbo-2024-04-09", "capacity": 8, "skuName":"GlobalStandard"},
    {"deployName": "gpt-4", "modelName": "gpt-4", "version": "0613", "capacity": 8}
  ],
  "SwitzerlandNorth": [
  ...
  "SwedenCentral": [
   ...
   "FranceCentral": [
    ...
    "southIndia": [
    {"deployName": "gpt-35-turbo", "modelName": "gpt-35-turbo", "version": "1106", "capacity": 30},
    {"deployName": "gpt-4o", "modelName": "gpt-4o", "version": "2024-05-13", "capacity": 30, "skuName":"GlobalStandard"},
    {"deployName": "gpt-4o-2024-05-13", "modelName": "gpt-4o", "version": "2024-05-13", "capacity": 100, "skuName":"ProvisionedManaged"},
    {"deployName": "gpt-4-turbo", "modelName": "gpt-4", "version": "turbo-2024-04-09", "capacity": 8, "skuName":"GlobalStandard"},
    {"deployName": "gpt-4-1106-preview", "modelName": "gpt-4", "version": "1106-Preview", "capacity": 8}
